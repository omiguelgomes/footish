...
export default function Profile() {
    return (
        <>
            <div className="flex flex-row bg-logo-pink-100 mt-10 mb-20 mx-10 rounded-[40px]">
            <div class="container mx-auto px-4">
                    ...
                    <div class="text-center mt-12">
                        ...
                        <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>23 Year old Student
                        </div>
                    </div>
